 ...
 *
 * Ava's system prompt reads from this file. We deliberately do NOT pass the
...
export const lyonsContext = {
  ...
  // What the typical caller is dealing with — helps Ava read the room and
  ...
  // The pricing position — not for quoting, but so Ava doesn't accidentally
